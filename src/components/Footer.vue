    ...
    <div class="footer-container">
      <div class="footer-content">
        ...
        <div class="footer-column">
          ...
          <ul class="footer-links">
            <li><a href="https://github.com/floraferal" target="_blank" class="footer-link">GitHub</a></li>
        ...
        <div class="footer-column">
          ...
          <ul class="footer-links">
            ...
            <li><a href="https://github.com/floraferal" target="_blank" class="footer-link">Contribute</a></li>
      ...
      <div class="footer-bottom">
        ...
        <div class="footer-social">
          <a href="https://github.com/floraferal" target="_blank" class="social-link" aria-label="GitHub">
